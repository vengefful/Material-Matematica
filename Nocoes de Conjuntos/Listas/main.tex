...
%\end{center}
    ...
    \begin{question}[type=exam]
      ...
      que, precisamente:
      \begin{tasks}
        \task 283 dos entrevistados já haviam dirigido automóvel;
        \task 127 dos entrevistados já haviam dirigido motocicletas;
        \task 67 dos entrevistados não haviam dirigido nenhum dos dois tipos de veículo. 
      \end{tasks}
    ...
    \begin{question}[type=exam]
      ...
      \begin{tasks}
        \task 32 professores lecionassem no prédio A;
        \task 30 professores lecionassem no prédio B;
        \task 29 professores lecionassem no prédio C;
        \task 17 professores lecionassem nos prédios A e B;
        \task 18 professores lecionassem nos prédios A e C;
        \task 13 professores lecionassem nos prédios B e C. 
      \end{tasks}
